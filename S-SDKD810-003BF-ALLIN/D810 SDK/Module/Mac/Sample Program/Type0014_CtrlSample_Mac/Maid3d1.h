...
enum eNkMAIDCapabilityD1
{
	...
	kNkMAIDCapability_WBTunePreset6				= kNkMAIDCapability_VendorBaseD1 + 0x255,
	kNkMAIDCapability_WBPresetProtect5			= kNkMAIDCapability_VendorBaseD1 + 0x256,
	kNkMAIDCapability_WBPresetProtect6			= kNkMAIDCapability_VendorBaseD1 + 0x257,
	kNkMAIDCapability_SpotWBMode				= kNkMAIDCapability_VendorBaseD1 + 0x258,
	kNkMAIDCapability_SpotWBMeasure				= kNkMAIDCapability_VendorBaseD1 + 0x259,
	kNkMAIDCapability_SpotWBChangeArea			= kNkMAIDCapability_VendorBaseD1 + 0x260,
	kNkMAIDCapability_SpotWBResultDispEnd		= kNkMAIDCapability_VendorBaseD1 + 0x261,
	kNkMAIDCapability_MovieWindNoiseReduction	= kNkMAIDCapability_VendorBaseD1 + 0x320,
	kNkMAIDCapability_RetractableLensWarningStatus = kNkMAIDCapability_VendorBaseD1 + 0x321,
	kNkMAIDCapability_ISOControlSensitivity		= kNkMAIDCapability_VendorBaseD1 + 0x322,
	kNkMAIDCapability_ExposureMeterLinkage		= kNkMAIDCapability_VendorBaseD1 + 0x330,
	kNkMAIDCapability_MovieRecordingZone		= kNkMAIDCapability_VendorBaseD1 + 0x350,
	kNkMAIDCapability_MovieISOControl			= kNkMAIDCapability_VendorBaseD1 + 0x351,
	kNkMAIDCapability_MovieISOAutoHiLimit		= kNkMAIDCapability_VendorBaseD1 + 0x352,
	kNkMAIDCapability_RawImageSize				= kNkMAIDCapability_VendorBaseD1 + 0x353,
	kNkMAIDCapability_RawJpegTransferStatus		= kNkMAIDCapability_VendorBaseD1 + 0x354,
	kNkMAIDCapability_LimitAFAreaMode			= kNkMAIDCapability_VendorBaseD1 + 0x355,
	kNkMAIDCapability_AFModeRestrictions		= kNkMAIDCapability_VendorBaseD1 + 0x356,
	kNkMAIDCapability_ExpBaseHighlight			= kNkMAIDCapability_VendorBaseD1 + 0x357,
	kNkMAIDCapability_ElectronicFrontCurtainShutter	= kNkMAIDCapability_VendorBaseD1 + 0x358,
	kNkMAIDCapability_PictureControlDataEx		= kNkMAIDCapability_VendorBaseD1 + 0x359,
	kNkMAIDCapability_MovieWBMode				= kNkMAIDCapability_VendorBaseD1 + 0x360,
	kNkMAIDCapability_MovieWBTuneAuto			= kNkMAIDCapability_VendorBaseD1 + 0x361,
	kNkMAIDCapability_MovieWBAutoType			= kNkMAIDCapability_VendorBaseD1 + 0x362,
	kNkMAIDCapability_MovieWBTuneIncandescent	= kNkMAIDCapability_VendorBaseD1 + 0x363,
	kNkMAIDCapability_MovieWBFluorescentType	= kNkMAIDCapability_VendorBaseD1 + 0x364,
	kNkMAIDCapability_MovieWBTuneFluorescent	= kNkMAIDCapability_VendorBaseD1 + 0x365,
	kNkMAIDCapability_MovieWBTuneSunny			= kNkMAIDCapability_VendorBaseD1 + 0x366,
	kNkMAIDCapability_MovieWBTuneShade			= kNkMAIDCapability_VendorBaseD1 + 0x368,
	kNkMAIDCapability_MovieWBTuneCloudy			= kNkMAIDCapability_VendorBaseD1 + 0x369,
	kNkMAIDCapability_MovieWBTuneColorTempEx	= kNkMAIDCapability_VendorBaseD1 + 0x36a,
	kNkMAIDCapability_MovieWBTuneColorAdjust	= kNkMAIDCapability_VendorBaseD1 + 0x36b,
	kNkMAIDCapability_MovieWBTunePreset1		= kNkMAIDCapability_VendorBaseD1 + 0x36c,
	kNkMAIDCapability_MovieWBTunePreset2		= kNkMAIDCapability_VendorBaseD1 + 0x36d,
	kNkMAIDCapability_MovieWBTunePreset3		= kNkMAIDCapability_VendorBaseD1 + 0x36e,
	kNkMAIDCapability_MovieWBTunePreset4		= kNkMAIDCapability_VendorBaseD1 + 0x36f,
	kNkMAIDCapability_MovieWBTunePreset5		= kNkMAIDCapability_VendorBaseD1 + 0x370,
	kNkMAIDCapability_MovieWBTunePreset6		= kNkMAIDCapability_VendorBaseD1 + 0x371,
	kNkMAIDCapability_MovieWBPresetProtect1		= kNkMAIDCapability_VendorBaseD1 + 0x372,
	kNkMAIDCapability_MovieWBPresetProtect2		= kNkMAIDCapability_VendorBaseD1 + 0x373,
	kNkMAIDCapability_MovieWBPresetProtect3		= kNkMAIDCapability_VendorBaseD1 + 0x374,
	kNkMAIDCapability_MovieWBPresetProtect4		= kNkMAIDCapability_VendorBaseD1 + 0x375,
	kNkMAIDCapability_MovieWBPresetProtect5		= kNkMAIDCapability_VendorBaseD1 + 0x376,
	kNkMAIDCapability_MovieWBPresetProtect6		= kNkMAIDCapability_VendorBaseD1 + 0x377,
	kNkMAIDCapability_MovieWBPresetNumber		= kNkMAIDCapability_VendorBaseD1 + 0x378,
	kNkMAIDCapability_MovieWBPresetName			= kNkMAIDCapability_VendorBaseD1 + 0x379,
	kNkMAIDCapability_MovieWBGainRed			= kNkMAIDCapability_VendorBaseD1 + 0x37a,
	kNkMAIDCapability_MovieWBGainBlue			= kNkMAIDCapability_VendorBaseD1 + 0x37b,
	kNkMAIDCapability_MoviePictureControlData	= kNkMAIDCapability_VendorBaseD1 + 0x37c,
	kNkMAIDCapability_MoviePictureControlDataEx	= kNkMAIDCapability_VendorBaseD1 + 0x37d,
	kNkMAIDCapability_MovieResetMenuBank		= kNkMAIDCapability_VendorBaseD1 + 0x37e,
	kNkMAIDCapability_MovieCCDDataMode			= kNkMAIDCapability_VendorBaseD1 + 0x37f,
	kNkMAIDCapability_MovieAutoDXCrop			= kNkMAIDCapability_VendorBaseD1 + 0x380,
	kNkMAIDCapability_MovieNoiseReductionHighISO = kNkMAIDCapability_VendorBaseD1 + 0x381,
	kNkMAIDCapability_MoviePictureControl		= kNkMAIDCapability_VendorBaseD1 + 0x382,
	kNkMAIDCapability_ChangedMoviePictureControl = kNkMAIDCapability_VendorBaseD1 + 0x383,
	kNkMAIDCapability_MovieResetWBMode			= kNkMAIDCapability_VendorBaseD1 + 0x384,
	kNkMAIDCapability_MovieMeteringMode			= kNkMAIDCapability_VendorBaseD1 + 0x385,
	kNkMAIDCapability_GetMoviePicCtrlInfo		= kNkMAIDCapability_VendorBaseD1 + 0x386,
	kNkMAIDCapability_DeleteMovieCustomPictureControl = kNkMAIDCapability_VendorBaseD1 + 0x387,
	kNkMAIDCapability_MovieWBPresetData			= kNkMAIDCapability_VendorBaseD1 + 0x388,
    kNkMAIDCapability_MirrorUpCancel                    = kNkMAIDCapability_VendorBaseD1 + 0x3ef,
    kNkMAIDCapability_MirrorUpStatus                    = kNkMAIDCapability_VendorBaseD1 + 0x3f0,
    kNkMAIDCapability_MirrorUpReleaseShootingCount      = kNkMAIDCapability_VendorBaseD1 + 0x3f1
};
...
enum eNkMAIDEventDX2
{
	...
	kNkMAIDEvent_CapChangeOperationOnly	= kNkMAIDEvent_D1Origin + 5, //0x10B	
    kNkMAIDEvent_1stCaptureComplete     = kNkMAIDEvent_D1Origin + 6, //0x10C
    kNkMAIDEvent_MirrorUpCancelComplete = kNkMAIDEvent_D1Origin + 7  //0x10D
};
...
enum eNkMAIDCameraType
{
	...
	kNkMAIDCameraType_D7100 = 0x35,	// D7100
	kNkMAIDCameraType_D5300,		// D5300
	kNkMAIDCameraType_Df,			// Df
	kNkMAIDCameraType_D610,			// D610
	kNkMAIDCameraType_D4S = 0x39,	// D4S
	kNkMAIDCameraType_D810 = 0x3A,	// D810
	kNkMAIDCameraType_D750,			// D750
	kNkMAIDCameraType_D5500,		// D5500
	kNkMAIDCameraType_D7200 = 0x3D,	// D7200
    kNkMAIDCameraType_D810A	= 0x3E	// D810A
};
...
enum eNkMAIDLiveViewImageZoomRate
{
	...
	kNkMAIDLiveViewImageZoomRate_13		= 7, //13Åì
...
{
	kNkMAIDMovieScreenSize4_FullHD_60i = 0,	  // FullHD (1920Å~1080):60i
	kNkMAIDMovieScreenSize4_FullHD_50i,		  // FullHD (1920Å~1080):50i
	kNkMAIDMovieScreenSize4_FullHD_30p,		  // FullHD (1920Å~1080):30p
	kNkMAIDMovieScreenSize4_FullHD_25p,		  // FullHD (1920Å~1080):25p
	kNkMAIDMovieScreenSize4_FullHD_24p,		  // FullHD (1920Å~1080):24p
	kNkMAIDMovieScreenSize4_720p_60p,		  // 720p (1280Å~720):60p
	kNkMAIDMovieScreenSize4_720p_50p		  // 720p (1280Å~720):50p
};

// kNkMAIDCapability_MovieScreenSize(0x8272)
enum eNkMAIDMovieScreenSize5
{
	kNkMAIDMovieScreenSize5_FullHD_1,		  // FullHD (1920Å~1080):60p/50p
	kNkMAIDMovieScreenSize5_FullHD_2,		  // FullHD (1920Å~1080):60i/50i
	kNkMAIDMovieScreenSize5_FullHD_3,		  // FullHD (1920Å~1080):30p/25p
	kNkMAIDMovieScreenSize5_FullHD_4,		  // FullHD (1920Å~1080):24p/24p
	kNkMAIDMovieScreenSize5_720p,			  // 720p (1280Å~720):60p/50p
	kNkMAIDMovieScreenSize5_VGA				  // VGA  (640Å~424) :30p/25p
};

// kNkMAIDCapability_MovieScreenSize(0x8272)
enum eNkMAIDMovieScreenSize6
{
	kNkMAIDMovieScreenSize6_FullHD_60p,		  // FullHD (1920Å~1080):60p
	kNkMAIDMovieScreenSize6_FullHD_50p,		  // FullHD (1920Å~1080):50p
	kNkMAIDMovieScreenSize6_FullHD_30p,		  // FullHD (1920Å~1080):30p
	kNkMAIDMovieScreenSize6_FullHD_25p,		  // FullHD (1920Å~1080):25p
	kNkMAIDMovieScreenSize6_FullHD_24p,		  // FullHD (1920Å~1080):24p
	kNkMAIDMovieScreenSize6_720p_60p,		  // 720p (1280Å~720):60p
	kNkMAIDMovieScreenSize6_720p_50p,		  // 720p (1280Å~720):50p
	kNkMAIDMovieScreenSize6_VGA_30p,		  // VGA  (640Å~424) :30p
	kNkMAIDMovieScreenSize6_VGA_25p,		  // VGA  (640Å~424) :25p
	kNkMAIDMovieScreenSize6_FullHD_30p_Crop,  // FullHD (1920Å~1080):30p Crop
	kNkMAIDMovieScreenSize6_FullHD_25p_Crop,  // FullHD (1920Å~1080):25p Crop
	kNkMAIDMovieScreenSize6_FullHD_24p_Crop   // FullHD (1920Å~1080):24p Crop
};
...
enum eNkMAIDHDRSmoothing
{
	...
	kNkMAIDHDRSmoothing_Auto,
	kNkMAIDHDRSmoothing_ExtraHigh
};
...
// kNkMAIDMovieWindNoiseReduction
...
// keNkMAIDLimitAFAreaMode
enum eNkMAIDLimitAFAreaMode
{
	kNkMAIDLimitAFAreaMode_Auto			= 0x0080,	//Bit7
	kNkMAIDLimitAFAreaMode_Group		= 0x0040,	//Bit6
	kNkMAIDLimitAFAreaMode_3DTtracking	= 0x0020,	//Bit5
	kNkMAIDLimitAFAreaMode_Dynamic51	= 0x0010,	//Bit4
	kNkMAIDLimitAFAreaMode_Dynamic21	= 0x0004,	//Bit2
	kNkMAIDLimitAFAreaMode_Dynamic9		= 0x0002	//Bit1
};

// keNkMAIDAFModeRestrictions
